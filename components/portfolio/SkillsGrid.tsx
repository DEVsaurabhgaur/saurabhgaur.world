...
const SKILL_GROUPS: SkillGroup[] = [
  {
    label: 'AI & LLM',
    color: '#FF4A26', // Bright cyberpunk red/orange
    skills: [
      'LLM Evaluation',
      'Prompt Engineering',
      'RLHF',
  ...
  {
    label: 'Languages',
    color: '#00D8FF', // Cyberpunk Cyan
    skills: ['Python', 'TypeScript', 'JavaScript', 'SQL', 'Bash'],
  },
  {
    label: 'Web & Frameworks',
    color: '#BD5CFF', // Neon Purple
    skills: ['Next.js', 'React', 'Tailwind CSS', 'Node.js', 'FastAPI', 'REST APIs'],
  },
  {
    label: 'Dev Tools',
    color: '#FFAD00', // Warning Gold
    skills: ['Git', 'GitHub', 'VS Code', 'Vercel', 'Docker', 'Linux'],
  },
  {
    label: 'Data & ML',
    color: '#00FF88', // Matrix Green
    skills: ['Pandas', 'NumPy', 'Jupyter', 'Supabase', 'PostgreSQL', 'Data Annotation'],
  },
]
        ...
        <div className="space-y-12">
          {SKILL_GROUPS.map((group) => (
            <div key={group.label} className="flex flex-col sm:flex-row sm:items-start gap-4 group/row">
              ...
              <div className="sm:w-48 shrink-0 flex items-center gap-3 select-none">
                <span 
              ...
              {/* Skill Node pills */}
              <div className="flex flex-wrap gap-2.5 sm:max-w-[65%]">
